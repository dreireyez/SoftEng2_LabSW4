...
Implement the Visitor Design Pattern based on the given diagram.
...
*Note: Getters were added to the interface, TelcoSubscription, to ensure that there are no changes to the given client program.*

## Class Diagram
![Class Diagram](VisitorDiagram.png)
